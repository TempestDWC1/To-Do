...
public class JwtUtil {
	...
	// used with our algorithm (salt) to hash / encode out token
	...
	// method takes a token, and claims a resolver to find out what the claims are of that token.
	...
	private String createToken(Map<String, Object> claims, String subject) {
		...
		// sets token based on Subject which is our Username
		...
		return Jwts.builder()
					...
					.setExpiration( new Date( System.currentTimeMillis() + 1000 * 60 * 60 * 10 ) ) // 1000 -> 1sec, 60 -> 1min, 60 -> 1hr, 10 -> 10hr
